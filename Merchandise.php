...
<html lang="en">
    ...
    <body>
        ...
        <div class="filter-border">
            ...
            <a class = "exportLink" download="MerchandiseData.xls" href="#" onclick="return ExcellentExport.excel(this, 'merchandiseTable', 'Merchandise Data');">Export as XLS</a>
            </br>
            <a class = "exportLink" download="MerchandiseData.csv" href="#" onclick="return ExcellentExport.csv(this, 'merchandiseTable');">Export as CSV</a>
            <div>
                </br>
            </div>
        </div>
