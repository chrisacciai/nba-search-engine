...
<html lang="en">
    ...
    <body>
        ...
        <div class="filter-border">
            ...
            <a class = "exportLink" download="VendorData.xls" href="#" onclick="return ExcellentExport.excel(this, 'vendorTable', 'Vendor Data');">Export as XLS</a>
            </br>
            <a class = "exportLink" download="VendorData.csv" href="#" onclick="return ExcellentExport.csv(this, 'vendorTable');">Export as CSV</a>
            <div>
                </br>
            </div>
        </div>
